...
Meshes in → JSON out. Produce one mesh per frame (frames 0–199, in the dataset's canonical frame), run `eval/score.py` (runs in minutes). See "Evaluate your method" in the README.
